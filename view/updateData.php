<div class="container d-flex flex-column flex-md-row justify-content-around">
	<div class="pt-5 pb-3">
		...
		<form method="post" action="<?= HOST; ?>/updateData">
			...
			<br>
			<div class="text-danger mt-3">Suppression de votre compte : <button onclick="window.location.href='<?= HOST; ?>/deleteSubscriber/<?= strip_tags($_SESSION['subscriberId']); ?>';">Supprimer</button></div>
		</form>
		<?php
