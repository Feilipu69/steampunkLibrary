...
if (isset($opinions)) {
	...
	foreach ($opinions as $opinion) {
		...
		?>
		<em><a href="<?= HOST; ?>/addRemoveAgree/<?= $opinion->getId(); ?>/<?= $_GET['page']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
...
</svg></a> : <?= $opinion->getAgree()[0]; ?></em> <em><a href="<?= HOST; ?>/addRemoveDisagree/<?= $opinion->getId(); ?>/<?= $_GET['page']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
...
</svg></a> : <?= $opinion->getDisagree()[0]; ?></em>
		</div>
		<?php
	}
	?>
