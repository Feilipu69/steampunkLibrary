...
</svg></a> : <?= $opinion->getAgree()[0]; ?></em> <em><a href="<?= HOST; ?>/addRemoveDisagree/<?= $opinion->getId(); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
